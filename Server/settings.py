...
SECRET_KEY = 'django-insecure-sqj7u&y0%+dw58@((@adt0+lpc)$!d6asq2@r+u7(ty9n*1cq('
...
Django settings for present_ease project.
...
MIDDLEWARE = [
    ...
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    'MIS.api.middlewares.error_handler.ErrorHandlingMiddleware',
    'MIS.api.middlewares.auth.AuthenticationMiddleware'
]
